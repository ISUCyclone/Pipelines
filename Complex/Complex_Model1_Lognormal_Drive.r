...
fit3 <- stan(file = "/Users/pro/Projects/Pipelines/Complex/Complex_Model1_Lognormal.stan",iter = 2000,warmup = 1000,control = list(adapt_delta = 0.95,max_treedepth = 12),data = Q1_data)
